...
This algorithm was written by me as an example for [**Terminus Research Hackathon**](https://github.com/TerminusResearch/hackathon). All other files to run a project and conditions can be found on the hackathon page on github. The presented code only implements the trading strategy as part of the overall hackathon project.
